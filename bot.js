...
client.on("ready", async () => {
  ...
  client.user.setActivity(`Hunter Development`, { type: "WATCHING" });

  console.log("Hunter Developerment!!");
});
...
client.on("guildMemberAdd", member => {
  ...
  codework.send(`
<a:RainbowOkGif:755739732666744843> ** Hoşgeldin! ${member} Seninle Birlikte ${
...
<a:RainbowOkGif:755739732666744843> ** Hesabın Oluşturulma Tarihi:** ${moment(
    member.user.createdAt
  ).format(" **YYYY __DD MMMM dddd (hh:mm:ss) __ **")} **
